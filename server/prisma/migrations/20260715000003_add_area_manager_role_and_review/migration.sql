...
ALTER TABLE "Store" ADD CONSTRAINT IF NOT EXISTS "Store_areaManagerId_fkey"
...
CREATE TABLE IF NOT EXISTS "AreaManagerReview" (
  ...
  CONSTRAINT "AreaManagerReview_batchId_fkey"
    FOREIGN KEY ("batchId") REFERENCES "UploadBatch"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "AreaManagerReview_storeId_fkey"
    FOREIGN KEY ("storeId") REFERENCES "Store"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "AreaManagerReview_areaManagerId_fkey"
    FOREIGN KEY ("areaManagerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "AreaManagerReview_batchId_storeId_key"
